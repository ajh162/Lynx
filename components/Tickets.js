              ...
              {tickets.map((ticket) => (
                <tr key={ticket.id} className="hover:bg-white hover:bg-opacity-10">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">
                    {/* CORRECCIÓN 1: Se eliminó role="group" */}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {/* CORRECCIÓN 2: Todos los labels conectados con htmlFor e id */}
                <div className="mb-3">
                  <label htmlFor="ticket-title" className="form-label">Título del ticket</label>
                  <input
                    id="ticket-title"
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="ticket-customer" className="form-label">Cliente</label>
                  <input
                    id="ticket-customer"
                    type="text"
                    className="form-control"
                ...
                <div className="mb-3">
                  <label htmlFor="ticket-priority" className="form-label">Prioridad</label>
                  <select
                    id="ticket-priority"
                ...
                <div className="mb-3">
                  <label htmlFor="ticket-status" className="form-label">Estado</label>
                  <select
                    id="ticket-status"
                    className="form-select"
                ...
                <div className="mb-3">
                  <label htmlFor="ticket-assignee" className="form-label">Asignado a</label>
                  <input
                    id="ticket-assignee"
                    type="text"
                    className="form-control"
