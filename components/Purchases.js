              ...
              {purchases.map((purchase) => (
                <tr key={purchase.id} className="hover:bg-white hover:bg-opacity-10">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">
                    {/* CORRECCIÓN 2: Se eliminó role="group" */}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {/* CORRECCIÓN 3: Todos los inputs tienen su Label conectado con htmlFor e ID */}
                <div className="mb-3">
                  <label htmlFor="purchase-product" className="form-label">Producto o servicio</label>
                  <input
                    id="purchase-product"
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="purchase-supplier" className="form-label">Proveedor</label>
                  <input
                ...
                <div className="mb-3">
                  <label htmlFor="purchase-amount" className="form-label">Monto ($)</label>
                  <input
                    id="purchase-amount"
                    type="number"
                    className="form-control"
                ...
                <div className="mb-3">
                  <label htmlFor="purchase-date" className="form-label">Fecha</label>
                  <input
                    id="purchase-date"
                    type="date"
                    className="form-control"
                ...
                <div className="mb-3">
                  <label htmlFor="purchase-status" className="form-label">Estado</label>
                  <select
                    id="purchase-status"
