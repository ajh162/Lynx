  ...
  return (
    ...
    >
      ...
      <nav className="space-y-2">
        {menuItems.map(item => (
          // CORRECCIÓN: Cambiamos div por button
          // Agregamos type="button", w-full y text-left para mantener el diseño
          <button
            key={item.id}
            type="button"
            className={`w-full text-left sidebar-item flex items-center space-x-3 ${
