    ...
    <div className="space-y-6" data-name="contacts" data-file="components/Contacts.js">
      ...
      <div className="glass-effect p-6 rounded-lg">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* CORRECCIÓN 1: Label asociado con htmlFor e ID */}
          <div>
            <label htmlFor="filter-category" className="block text-sm font-medium text-gray-700 mb-2">Filtrar por Categoría</label>
            <select
              id="filter-category"
          ...
          {/* CORRECCIÓN 2: Label asociado con htmlFor e ID */}
          <div>
            <label htmlFor="search-name" className="block text-sm font-medium text-gray-700 mb-2">Buscar por Nombre</label>
            <input
              id="search-name"
              type="text"
          ...
          {/* CORRECCIÓN 3: Label asociado con htmlFor e ID */}
          <div>
            <label htmlFor="search-company" className="block text-sm font-medium text-gray-700 mb-2">Buscar por Empresa</label>
            <input
              id="search-company"
              type="text"
