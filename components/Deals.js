    ...
    if (newDeal.title && newDeal.client && newDeal.value) {
      if (editingDeal) {
        setDeals(deals.map(d => d.id === editingDeal.id ? { 
          ...editingDeal, 
          ...newDeal, 
          // CORRECCIÓN 1: Usar Number.parseFloat
          value: Number.parseFloat(newDeal.value) 
        } : d));
        setEditingDeal(null);
      } else {
        setDeals([...deals, { 
              ...
              {deals.map((deal) => (
                <tr key={deal.id} className="hover:bg-white hover:bg-opacity-10">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">
                    {/* CORRECCIÓN 2: Eliminamos role="group" que causaba conflicto en el div */}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {/* CORRECCIÓN 3: Agregamos htmlFor e id a TODOS los campos */}
                <div className="mb-3">
                  <label htmlFor="deal-title" className="form-label">Título del negocio</label>
                  <input
                    id="deal-title"
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="deal-client" className="form-label">Cliente</label>
                  <input
                    id="deal-client"
                    type="text"
                    className="form-control"
                ...
                <div className="mb-3">
                  <label htmlFor="deal-value" className="form-label">Valor ($)</label>
                  <input
                    id="deal-value"
                    type="number"
                    className="form-control"
                ...
                <div className="mb-3">
                  <label htmlFor="deal-stage" className="form-label">Etapa</label>
                  <select
                    id="deal-stage"
                ...
                <div className="mb-3">
                  <label htmlFor="deal-date" className="form-label">Fecha de cierre</label>
                  <input
                    id="deal-date"
                    type="date"
                    className="form-control"
