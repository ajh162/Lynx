          ...
          {activeTab === 'general' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* CORRECCIÓN 1: Label conectado al input */}
                <div>
                ...
                {/* CORRECCIÓN 2: Label conectado al input */}
                <div>
                ...
                {/* CORRECCIÓN 3: Label conectado al select */}
                <div>
                ...
                {/* CORRECCIÓN 4: Label conectado al select */}
                <div>
